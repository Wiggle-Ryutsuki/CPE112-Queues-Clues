...
void talkTo(Player *player, char *name){                                                // Argument is just the player
    ...
    if (loc->npcId == -1){                                                        // If there isn't an NPC present, then...
        ...
        if (Inventory[HoneyID].id == -1){                                                   // If player doesn't have honey yet 
            printf(AnsiColorYellow "Farmer Joe:" AnsiColorReset " Well howdy there, stranger! Don't see many new faces 'round these parts. Somethin' I can help ya with? You look like you're searchin' for somethin'.\n");
            ...
            if (choice == 1)                                                            
            {
                printf(AnsiColorYellow "\nFarmer Joe:" AnsiColorReset " Your cat, ya say? Aww, that's a shame. Hate to see a critter lost. Hmm... you know, it's funny you mention that. Earlier this mornin', I did see a flash of fur boltin' past my field. Real quick little thing.\n");

                clearInputBuffer();                                                     // Stops automatically continuing
                printf("\n> Continue...");                                              // Little pause
                getchar();                                                              // Press enter to continue

                printf(AnsiColorYellow "\nFarmer Joe:" AnsiColorReset " Couldn't get a good look, mind you, but it definitely hightailed it straight into the forest, maybe towards that old cave entrance people talk about? Might be worth checkin' out, eh?\n");

                printf("\n> OK, thanks.");                                              // Little pause
                getchar();                                                              // Press enter to continue

                printf(AnsiColorYellow "\nFarmer Joe:" AnsiColorReset " Tell ya what, that cave can be a bit dark and gloomy. Here...(Farmer pulls out a small jar of honey) Take this. Fresh from my hives. A little sweetness might keep your spirits up on your search. Good luck findin' your furry friend!\n\n");
                ...
                clearInputBuffer();
                printf(AnsiColorYellow "\nFarmer Joe:" AnsiColorReset " Why thank you kindly! Takes a lot of work, but it's honest work. Be careful wanderin' around, especially in that forest.\n");
                printf("\n> You're welcome.");                                            // Little pause
                getchar();                                                              // Press enter to continue
            }
            else if (choice == 3){
                ...
                printf(AnsiColorYellow "\nFarmer Joe:" AnsiColorReset " looks at you quizzically.\n");
        }
        else{
